...
@Component({
  selector: 'app-edit-profile-employer',
  templateUrl: './edit-profile-employer.component.html',
  styleUrls: ['./edit-profile-employer.component.scss'],
  providers: [NgbCarouselConfig]
})
export class EditProfileEmployerComponent implements OnInit, OnDestroy {
